...
class COMBookSet:
    ...
    _reg_progid_ = 'BookServer'
    _reg_class_spec_ = 'comservers.COMBookSet'
    _public_methods_ = [
                'double',
    ...
    def __init__(self):
        ...
        self.__BookSet = userhooks.UserBookSet()
    ...
    def interpretString(self, expr):
        ...
        open('D:\\workspace\\ppw32_working\\Chapter_8\\booksetlog.txt','a').write('interpretString:' + str(expr) + '\n')
    ...
    def importFile(self, fullpathname):
        ...
        if found:
            (file_name, pathname, description) = found
            try:
                module = imp.load_module(root, file_name, pathname, description)
...
def TestCOM():
    #try:
    comtran = win32com.client.dynamic.Dispatch("Transaction")
